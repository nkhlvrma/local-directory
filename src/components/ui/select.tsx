...
// w-full rather than shadcn's default w-fit: every select in this app is a
// form field sitting beside full-width inputs, and a trigger that shrank to
// its current value left the row visibly ragged. Re-apply if `shadcn add
// select` ever overwrites this file.
